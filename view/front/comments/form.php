<div class='comments container table-responsive'>
    <form action="index.php?page=<?php echo $_GET['page']; ?>&action=seeComments&id=<?= $articleId ?>" method="post" class='row'>
        <div class='col-md-2 text-center pl-1 pr-1 form-group'>
            ...
            <button type='submit' name='new-comment' class='btn btn-outline-dark mt-3'>Envoyer</button>
        </div>
